...
| 2주차 | 기능적/비기능적 요구사항 분석, MVC 설계, DB 필드 초안 작성, 화면 설계 | 전체 | 요구사항 및 설계 문서 |
...
| 5주차 | BookDTO/BookDAO 작성, 도서 등록 및 목록 조회 기능 구현 | 전체 | 도서 CRUD 일부 |
| 6주차 | 도서 수정/삭제, 대여/반납 기능 구현 | 전체 | 주요 기능 구현 |
| 7주차 | 화면 연결, 오류 수정, 통합 테스트 | 전체 | 테스트 결과 |
